...
func (*Timestamp) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{0} }
...
func (*Author) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{1} }
...
func (*Content) Descriptor() ([]byte, []int) { return fileDescriptor6, []int{3} }
...
func init() { proto.RegisterFile("page.proto", fileDescriptor6) }
